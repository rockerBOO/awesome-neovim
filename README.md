...
- [nemanjamalesija/ts-expand-hover.nvim](https://github.com/nemanjamalesija/ts-expand-hover.nvim) - Expandable TypeScript type inspection using TypeScript 5.9's `verbosityLevel` API. Progressively expand and collapse type aliases directly inside the hover float.
