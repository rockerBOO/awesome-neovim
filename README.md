...
- [saya-ashen/agent-workbench.nvim](https://github.com/saya-ashen/agent-workbench.nvim) - Workspace frontend for [pi](https://pi.dev) with sessions, diff review, and persistent shell worksheets.
