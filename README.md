...
- [StubbornVegeta/llm.nvim](https://github.com/StubbornVegeta/llm.nvim) - Free large language model (LLM) support for Neovim, provides commands to interact with LLM.
