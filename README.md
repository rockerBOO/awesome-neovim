...
- [ln.nvim](https://github.com/markosnarinian/ln.nvim) - Relative numbers on the active window, absolute everywhere else. Switches based on focus, mode, and filetype with sane defaults and easy configuration.
