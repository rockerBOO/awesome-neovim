...
- [Darkskittlz/GitCompanion](https://github.com/Darkskittlz/GitCompanion) - A lightweight, terminal-native Git interface floating window for Neovim. Inspect diffs, manage branches, stage modified files, manage stashes, and handle merges or commits without leaving your neovim editor.
