...
- [teocns/neocursor.nvim](https://github.com/teocns/neocursor.nvim) - Next-edit predictions, cursor jumps, and ghost text from Cursor's Tab model, driven by an existing Cursor session instead of an API key.
