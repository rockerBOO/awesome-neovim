...
- [caskstrength/nvim-wildcat](https://codeberg.org/caskstrength/nvim-wildcat) - Neovim plugin for deploying Java war (or ear) files on Tomcat, JBoss or Wildfly.
...
- [caskstrength/nvim-springtime](https://codeberg.org/caskstrength/nvim-springtime) - Neovim plugin based on Spring Initializr.
