...
- [carloscalla/notepad.nvim](https://github.com/carloscalla/notepad.nvim) -A Neovim plugin for quick note-taking in markdown with repo-specific or global notepad support. 
<!--lint disable double-link -->
[**⬆ back to top**](#contents)
<!--lint enable double-link -->
