...
- [simaxme/java.nvim](https://github.com/simaxme/java.nvim#configuring-the-plugin) - Plugin with some utilities regarding Java development (e.g. updating symbol usages when renaming or moving a file in nvim-tree).
