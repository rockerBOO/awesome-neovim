...
- [ChrisGVE/docshelf.nvim](https://github.com/ChrisGVE/docshelf.nvim) - Offline API documentation from devdocs.io, Hackage, docs.rs, Sphinx sites, pkg.go.dev and DocC sites, converted once to text for reading and grepping in a buffer, with per-language filtering and automatic updates.
