...
- [~lorenzwegener/nvim-dirdiff](https://git.sr.ht/~lorenzwegener/nvim-dirdiff) - Lua port of `vim-dirdiff` that recursively diffs two directories using the built-in diff mode.
