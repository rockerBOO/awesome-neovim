...
- [DrKJeff16/nvim-plugin-boilerplate](https://github.com/DrKJeff16/nvim-plugin-boilerplate) - A template for new plugins with dynamic setup, annotations and CI utilities.
