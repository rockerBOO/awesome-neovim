...
- [cpea2506/relative-toggle.nvim](https://github.com/cpea2506/relative-toggle.nvim) - A highly customizable plugin to automatically toggle smoothly between number and relative numbers, supporting various number combinations.
