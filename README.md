...
- [deathbeam/autocomplete.nvim](https://github.com/deathbeam/autocomplete_nvim) - Very simple and minimal autocompletion for cmdline and buffer using LSP and Tree-sitter with signature help.
