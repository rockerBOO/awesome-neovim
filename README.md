...
- [RRethy/vim-illuminate](https://github.com/RRethy/vim-illuminate) - Plugin to automatically highlight other uses of the word under the cursor using either LSP, Tree-sitter, or regex matching.
