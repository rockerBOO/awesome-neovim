...
- [ray-x/copilot-agent.nvim](https://github.com/ray-x/copilot-agent.nvim) - Autonomous orchestrator built with the GitHub Copilot Go SDK, providing native agentic tool execution and session persistence.
