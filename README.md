...
- [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) - AI knowledge work in portable .chat files you own: documents, research and code across Claude, GPT and Gemini.
