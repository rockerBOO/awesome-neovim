...
- [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) - Leverage coding assistants for chat and code generation. An AI/LLM plugin focused on tool-use, like Aider, Cursor and Windsurf.
