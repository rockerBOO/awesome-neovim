...
- [avifenesh/agnix](https://github.com/avifenesh/agnix) - LSP-based linter for AI agent configuration files (CLAUDE.md, SKILL.md, hooks, MCP, .cursorrules) with 156 rules and auto-fix.
