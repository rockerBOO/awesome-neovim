...
- [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) - Full-fledged IDE powered by [lazy.nvim](https://github.com/folke/lazy.nvim) to make it easy to customize and extend your config.
