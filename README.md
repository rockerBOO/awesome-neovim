...
- [Senal-D-A-Gunaratna/swapson.nvim](https://github.com/Senal-D-A-Gunaratna/swapson.nvim) - Drop-in replacement for `mason.nvim`'s npm package manager by routing package installs through `bun` for faster setup.
