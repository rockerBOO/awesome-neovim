...
- [3ZsForInsomnia/code-companion-picker](https://github.com/3ZsForInsomnia/code-companion-picker) - Telescope and Snacks picker intergrations for previewing CodeCompanion prompts.
<!--lint disable double-link -->
