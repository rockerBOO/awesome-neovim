...
- [artart222/CodeArt](https://github.com/artart222/CodeArt) - A fast general-purpose IDE Written entirely in lua with installer for linux/windows/macOS and built in `:CodeArtUpdate` command for updating it for linux and macOS.
