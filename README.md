...
- [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) - Copilot Chat like experience for Neovim, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
