...
- [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) - Leverage coding agents in Neovim. An AI/LLM plugin focused on tool-use, like Aider, Cursor or Windsurf.
