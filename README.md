...
- [Mr-LLLLL/interestingwords.nvim](https://github.com/Mr-LLLLL/interestingwords.nvim) - Interesting word. highlight multiple word same time, navigate word under cursor with scrolling smoothly, display search count in virualtext.
