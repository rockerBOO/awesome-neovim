...
- [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) - VSCode-style side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
