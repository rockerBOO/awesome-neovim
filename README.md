...
- [~nedia/auto-save.nvim](https://git.sr.ht/~nedia/auto-save.nvim) - Extremely simple auto saving on `InsertLeave` & `TextChanged`. Based on [Pocco81/AutoSave](https://github.com/Pocco81/AutoSave.nvim) but lighter.
