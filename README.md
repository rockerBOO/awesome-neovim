...
- [Exafunction/codeium.vim](https://github.com/Exafunction/codeium.vim) - Free AI powered code assistance plugin for Vim and Neovim using [Codeium](https://www.codeium.com).
