...
- [linrongbin16/gitlinker.nvim](https://github.com/linrongbin16/gitlinker.nvim) - A plugin to generate sharable file permalinks (with line ranges) for git host websites, fork of [ruifm's gitlinker](https://github.com/ruifm/gitlinker.nvim), refactored with pattern based rule engine, windows support and other enhancements.
