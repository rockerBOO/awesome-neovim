...
- [zeybek/camouflage.nvim](https://github.com/zeybek/camouflage.nvim) - Mask sensitive values in config files (.env, JSON, YAML, TOML) during screen sharing using extmarks.
