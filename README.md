...
- [ankushbhagats/pastel.nvim](https://github.com/ankushbhagats/pastel.nvim) - **_`[TS][LSP][L/D][Lua]`_** Elegant pastel colorschemes for Neovim with advanced customization, styles, and integrations.
<!--lint disable double-link -->
[**⬆ back to top**](#contents)
<!--lint enable double-link -->
