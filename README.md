...
- [paulburgess1357/nvim-mcp](https://github.com/paulburgess1357/nvim-mcp) - MCP server that gives AI agents access to buffers, commands, and LSP diagnostics through Neovim's msgpack-RPC socket. Be sure to [work safely](https://github.com/paulburgess1357/nvim-mcp#working-safely) when giving LLMs access to Neovim.
