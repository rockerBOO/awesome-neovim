...
- [shellRaining/hlchunk.nvim](https://github.com/shellRaining/hlchunk.nvim) - a lua implementation of nvim-hlchunk, small and will be more fast, contains more features, including hightlight `{}` chunk, hightlight indentline, etc. 
