...
- [xero/miasma.nvim](https://github.com/xero/miasma.nvim) - A dark pastel color scheme inspired by the woods. Built using lush and supports treesitter, diagnostics, gitsigns, cmp, telescope, whichkey, lazy, and more.
