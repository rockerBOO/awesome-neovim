...
- [ymich9963/mdnotes.nvim](https://github.com/ymich9963/mdnotes.nvim) - Improved Markdown note taking in Neovim with better Wikilink support, adding/removing hyperlinks to images/files/URLs, file history, asset management, referencing, backlinks, and formatting.
<!--lint disable double-link -->
