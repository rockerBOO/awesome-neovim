...
- [JesperLundberg/projektgunnar.nvim](https://github.com/JesperLundberg/projektgunnar) - C# dependency manager, add/update/remove nugets. Also handle references between projects and solution files.
