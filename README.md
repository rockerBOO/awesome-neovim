...
- [karshPrime/switchboard](https://github.com/karshPrime/switchboard.nvim) - Define "run", "build", or any custom command/bind per language or project, then use the same keybinds everywhere. Runs these commands in :term, a split, or seamlessly through tmux depending on setup.
