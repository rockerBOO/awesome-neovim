...
- [lizixi-0x2F/xaster](https://github.com/lizixi-0x2F/xaster) - Neovim-native AI coding agent with EXPLORE→PLAN→EXECUTE→VERIFY loop, edit confirmation, Vim grammar tools, and 70+ native tools.
