...
- [ankushbhagats/match.nvim](https://github.com/ankushbhagats/match.nvim) - Minimal floating search & replace with live match tracking, navigation, and quick replacements.
