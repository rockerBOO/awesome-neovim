...
- [sduras/duras_bridge](https://github.com/sduras/duras_bridge) - Minimal bridge between buffer, system clipboard, and the duras daily notes CLI; opens notes without spawning a nested editor.
