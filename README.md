...
- [Owen-Dechow/videre.nvim](https://github.com/Owen-Dechow/videre.nvim) - Explore JSON, YAML, & TOML, files visually as a nested unit/node-based graphical representation.
