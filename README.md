...
- [jaitd/fieldguide.nvim](https://github.com/jaitd/fieldguide.nvim) - Sidebar agent for your own config: answers from the docs of the plugins you have installed, at the versions on disk, and from the live session, and checks each edit by booting the config in a sandbox.
<!--lint disable double-link -->
[**⬆ back to top**](#contents)
<!--lint enable double-link -->
