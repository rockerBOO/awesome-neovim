...
- [drybalka/clean.nvim](https://github.com/drybalka/clean.nvim) - Cleaning up the default key mappings and plugins in Neovim and leaving only the bare essentials to build upon.
