...
- [mistweaverco/uzuri.nvim](https://github.com/mistweaverco/uzuri.nvim) - Improve the built-in `vim.ui` interfaces. A maintained fork of [dressing.nvim](https://github.com/stevearc/dressing.nvim).
